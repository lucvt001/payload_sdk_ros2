...
{
    node_->declare_parameter("set_gimbal_angle_server_name", "/psdk_wrapper_node/set_gimbal_angle");
    node_->get_parameter("set_gimbal_angle_server_name", set_gimbal_angle_server_name_);

    set_gimbal_angle_srv_ = node_->create_service<psdk_interfaces::srv::SetGimbalAngle>(
...
void GimbalWrapper::handle_set_gimbal_angle(
